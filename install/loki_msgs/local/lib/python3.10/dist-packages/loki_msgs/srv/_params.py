...
class Metaclass_Params(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from loki_msgs.srv import _params
...
class Params(metaclass=Metaclass_Params):
    from loki_msgs.srv._params import Params_Request as Request
    from loki_msgs.srv._params import Params_Response as Response
