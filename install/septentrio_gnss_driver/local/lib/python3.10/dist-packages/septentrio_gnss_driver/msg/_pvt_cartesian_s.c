...
bool septentrio_gnss_driver__msg__pvt_cartesian__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("septentrio_gnss_driver.msg._pvt_cartesian.PVTCartesian", full_classname_dest, 54) == 0);
  }
  septentrio_gnss_driver__msg__PVTCartesian * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PVTCartesian */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("septentrio_gnss_driver.msg._pvt_cartesian");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PVTCartesian");
