  ...
  std::ostream & out)
{
  ...
  // member: vector_info_cart
  {
    if (msg.vector_info_cart.size() == 0) {
      out << "vector_info_cart: []";
    } else {
      out << "vector_info_cart: [";
      size_t pending_items = msg.vector_info_cart.size();
      for (auto item : msg.vector_info_cart) {
...
inline std::string to_yaml(const BaseVectorCart & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const septentrio_gnss_driver::msg::BaseVectorCart & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const septentrio_gnss_driver::msg::BaseVectorCart & msg)
{
