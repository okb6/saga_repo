...
void septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_init_function(
...
void septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_fini_function(void * message_memory)
{
  septentrio_gnss_driver__msg__PosCovGeodetic__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_member_array[14] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_members = {
  ...
  septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_member_array,  // message members
  septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_init_function,  // function to initialize message memory (memory has to be allocated)
  septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_type_support_handle = {
  0,
  &septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, septentrio_gnss_driver, msg, PosCovGeodetic)() {
  septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_member_array[1].members_ =
  ...
  if (!septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_type_support_handle.typesupport_identifier) {
    septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &septentrio_gnss_driver__msg__PosCovGeodetic__rosidl_typesupport_introspection_c__PosCovGeodetic_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
