...
inline std::string to_yaml(const PVTCartesian & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const septentrio_gnss_driver::msg::PVTCartesian & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const septentrio_gnss_driver::msg::PVTCartesian & msg)
{
