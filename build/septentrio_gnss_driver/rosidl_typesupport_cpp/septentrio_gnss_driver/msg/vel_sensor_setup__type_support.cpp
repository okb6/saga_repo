...
static const _VelSensorSetup_type_support_symbol_names_t _VelSensorSetup_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, septentrio_gnss_driver, msg, VelSensorSetup)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, septentrio_gnss_driver, msg, VelSensorSetup)),
  }
};
...
{
  return &::septentrio_gnss_driver::msg::rosidl_typesupport_cpp::VelSensorSetup_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, septentrio_gnss_driver, msg, VelSensorSetup)() {
  return get_message_type_support_handle<septentrio_gnss_driver::msg::VelSensorSetup>();
}
