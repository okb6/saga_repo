...
static const _MeasEpoch_type_support_symbol_names_t _MeasEpoch_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, septentrio_gnss_driver, msg, MeasEpoch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, septentrio_gnss_driver, msg, MeasEpoch)),
  }
};
...
{
  return &::septentrio_gnss_driver::msg::rosidl_typesupport_cpp::MeasEpoch_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, septentrio_gnss_driver, msg, MeasEpoch)() {
  return get_message_type_support_handle<septentrio_gnss_driver::msg::MeasEpoch>();
}
