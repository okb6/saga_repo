...
void fetch_function__BaseVectorCart__vector_info_cart(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const septentrio_gnss_driver::msg::VectorInfoCart *>(
    get_const_function__BaseVectorCart__vector_info_cart(untyped_member, index));
  auto & value = *reinterpret_cast<septentrio_gnss_driver::msg::VectorInfoCart *>(untyped_value);
  value = item;
}

void assign_function__BaseVectorCart__vector_info_cart(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<septentrio_gnss_driver::msg::VectorInfoCart *>(
    get_function__BaseVectorCart__vector_info_cart(untyped_member, index));
  const auto & value = *reinterpret_cast<const septentrio_gnss_driver::msg::VectorInfoCart *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BaseVectorCart_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__BaseVectorCart__vector_info_cart,  // fetch(index, &value) function pointer
    assign_function__BaseVectorCart__vector_info_cart,  // assign(index, value) function pointer
