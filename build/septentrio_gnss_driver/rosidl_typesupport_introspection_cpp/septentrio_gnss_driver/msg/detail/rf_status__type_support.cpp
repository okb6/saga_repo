...
void fetch_function__RFStatus__rfband(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const septentrio_gnss_driver::msg::RFBand *>(
    get_const_function__RFStatus__rfband(untyped_member, index));
  auto & value = *reinterpret_cast<septentrio_gnss_driver::msg::RFBand *>(untyped_value);
  value = item;
}

void assign_function__RFStatus__rfband(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<septentrio_gnss_driver::msg::RFBand *>(
    get_function__RFStatus__rfband(untyped_member, index));
  const auto & value = *reinterpret_cast<const septentrio_gnss_driver::msg::RFBand *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RFStatus_message_member_array[6] = {
  ...
  },
  {
    ...
    fetch_function__RFStatus__rfband,  // fetch(index, &value) function pointer
    assign_function__RFStatus__rfband,  // assign(index, value) function pointer
