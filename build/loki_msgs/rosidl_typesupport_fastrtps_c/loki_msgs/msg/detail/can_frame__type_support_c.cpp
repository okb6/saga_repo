...
#include "loki_msgs/msg/detail/can_frame__rosidl_typesupport_fastrtps_c.h"
...
using _CANFrame__ros_msg_type = loki_msgs__msg__CANFrame;
...
static uint32_t _CANFrame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_loki_msgs__msg__CANFrame(
...
static size_t _CANFrame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_loki_msgs__msg__CANFrame(
