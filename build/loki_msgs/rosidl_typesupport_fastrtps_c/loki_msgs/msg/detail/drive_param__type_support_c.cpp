...
#include "loki_msgs/msg/detail/drive_param__rosidl_typesupport_fastrtps_c.h"
...
using _DriveParam__ros_msg_type = loki_msgs__msg__DriveParam;
...
static uint32_t _DriveParam__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_loki_msgs__msg__DriveParam(
...
static size_t _DriveParam__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_loki_msgs__msg__DriveParam(
