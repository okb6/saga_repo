...
{
  new (message_memory) loki_msgs::msg::CANFrame(_init);
}

void CANFrame_fini_function(void * message_memory)
{
  auto typed_message = static_cast<loki_msgs::msg::CANFrame *>(message_memory);
...
void resize_function__CANFrame__data(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<uint8_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CANFrame_message_member_array[3] = {
  {
    ...
    offsetof(loki_msgs::msg::CANFrame, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(loki_msgs::msg::CANFrame, length),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(loki_msgs::msg::CANFrame, data),  // bytes offset in struct
    nullptr,  // default value
    ...
    resize_function__CANFrame__data  // resize(index) function pointer
  }
};
...
get_message_type_support_handle<loki_msgs::msg::CANFrame>()
{
  return &::loki_msgs::msg::rosidl_typesupport_introspection_cpp::CANFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, loki_msgs, msg, CANFrame)() {
  return &::loki_msgs::msg::rosidl_typesupport_introspection_cpp::CANFrame_message_type_support_handle;
}
