...
#ifndef LOKI_MSGS__SRV__DETAIL__SET_BOOLS__FUNCTIONS_H_
#define LOKI_MSGS__SRV__DETAIL__SET_BOOLS__FUNCTIONS_H_
...
/// Initialize srv/SetBools message.
/**
...
/// Create srv/SetBools message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * loki_msgs__srv__SetBools_Request__init().
...
/// Destroy srv/SetBools message.
/**
 * It calls
 * loki_msgs__srv__SetBools_Request__fini()
...
/// Check for srv/SetBools message equality.
/**
...
/// Initialize array of srv/SetBools messages.
/**
...
/// Finalize array of srv/SetBools messages.
/**
 * It calls
 * loki_msgs__srv__SetBools_Request__fini()
...
/// Create array of srv/SetBools messages.
/**
 * It allocates the memory for the array and calls
 * loki_msgs__srv__SetBools_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetBools messages.
/**
 * It calls
 * loki_msgs__srv__SetBools_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetBools message array equality.
/**
...
/// Copy an array of srv/SetBools messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * loki_msgs__srv__SetBools_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_loki_msgs
...
/**
 * It calls
 * loki_msgs__srv__SetBools_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_loki_msgs
...
/**
 * It allocates the memory for the array and calls
 * loki_msgs__srv__SetBools_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_loki_msgs
...
/**
 * It calls
 * loki_msgs__srv__SetBools_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LOKI_MSGS__SRV__DETAIL__SET_BOOLS__FUNCTIONS_H_
