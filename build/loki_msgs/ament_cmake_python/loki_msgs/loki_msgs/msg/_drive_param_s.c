...
bool loki_msgs__msg__drive_param__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("loki_msgs.msg._drive_param.DriveParam", full_classname_dest, 37) == 0);
  }
  loki_msgs__msg__DriveParam * ros_message = _ros_message;
  {  // index
...
PyObject * loki_msgs__msg__drive_param__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("loki_msgs.msg._drive_param");
