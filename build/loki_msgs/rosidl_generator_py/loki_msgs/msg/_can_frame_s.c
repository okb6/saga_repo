...
bool loki_msgs__msg__can_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("loki_msgs.msg._can_frame.CANFrame", full_classname_dest, 33) == 0);
  }
  loki_msgs__msg__CANFrame * ros_message = _ros_message;
  {  // id
...
PyObject * loki_msgs__msg__can_frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("loki_msgs.msg._can_frame");
