...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_amps = kwargs.get('motor_amps', float())
        self.relative_power = kwargs.get('relative_power', int())
    ...
    def __eq__(self, other):
        ...
        if self.position != other.position:
            return False
        if self.motor_amps != other.motor_amps:
            return False
        if self.relative_power != other.relative_power:
            return False
        return True
    ...
    @builtins.property
    def motor_amps(self):
        """Message field 'motor_amps'."""
        return self._motor_amps

    @motor_amps.setter
    def motor_amps(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'motor_amps' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'motor_amps' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._motor_amps = value

    @builtins.property
    def relative_power(self):
        """Message field 'relative_power'."""
        return self._relative_power

    @relative_power.setter
    def relative_power(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'relative_power' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'relative_power' field must be an integer in [-32768, 32767]"
        self._relative_power = value
