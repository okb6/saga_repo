...
#include "loki_msgs/msg/detail/controller_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const loki_msgs::msg::ControllerInfo & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: drive_directions
  {
    cdr << ros_message.drive_directions;
  }
  // Member: home_counts
  {
    cdr << ros_message.home_counts;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  loki_msgs::msg::ControllerInfo & ros_message)
{
  // Member: drive_directions
  {
    cdr >> ros_message.drive_directions;
  ...
  size_t current_alignment)
{
  ...
  // Member: drive_directions
  {
    ...
    size_t item_size = sizeof(ros_message.drive_directions[0]);
  ...
  // Member: home_counts
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.home_counts[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const loki_msgs::msg::ControllerInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<loki_msgs::msg::ControllerInfo *>(
    untyped_ros_message);
...
{
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_ControllerInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, msg, ControllerInfo)() {
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_ControllerInfo__handle;
}
