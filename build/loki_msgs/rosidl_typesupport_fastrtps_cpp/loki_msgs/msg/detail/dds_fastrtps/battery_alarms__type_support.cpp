...
#include "loki_msgs/msg/detail/battery_alarms__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const loki_msgs::msg::BatteryAlarms & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  loki_msgs::msg::BatteryAlarms & ros_message)
{
  // Member: over_voltage_protection
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const loki_msgs::msg::BatteryAlarms *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<loki_msgs::msg::BatteryAlarms *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BatteryAlarms__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const loki_msgs::msg::BatteryAlarms *>(
...
static size_t _BatteryAlarms__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BatteryAlarms(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BatteryAlarms__callbacks = {
  "loki_msgs::msg",
  "BatteryAlarms",
...
static rosidl_message_type_support_t _BatteryAlarms__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BatteryAlarms__callbacks,
...
{
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_BatteryAlarms__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, msg, BatteryAlarms)() {
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_BatteryAlarms__handle;
}
