...
#include "loki_msgs/msg/detail/controller_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const loki_msgs::msg::ControllerStatusFlag &,
...
cdr_serialize(
  const loki_msgs::msg::ControllerState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  loki_msgs::msg::ControllerState & ros_message)
{
  // Member: controller_mode
  cdr >> ros_message.controller_mode;
  ...
  // Member: status_flags
  {
    ...
    ros_message.status_flags.resize(size);
    for (size_t i = 0; i < size; i++) {
      loki_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.status_flags[i]);
    }
  }
  ...
  // Member: status_flags
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.status_flags[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: status_flags
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        loki_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ControllerStatusFlag(
...
{
  auto typed_message =
    static_cast<const loki_msgs::msg::ControllerState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<loki_msgs::msg::ControllerState *>(
    untyped_ros_message);
...
{
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, msg, ControllerState)() {
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
