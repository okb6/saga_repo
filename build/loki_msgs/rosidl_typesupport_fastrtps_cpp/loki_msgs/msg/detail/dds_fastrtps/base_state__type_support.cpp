...
#include "loki_msgs/msg/detail/base_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const loki_msgs::msg::BaseState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: prop_speed
  {
    cdr << ros_message.prop_speed;
  }
  // Member: prop_pos
  {
    cdr << ros_message.prop_pos;
  }
  // Member: steer_speed
  {
  ...
  // Member: steer_pos
  {
    cdr << ros_message.steer_pos;
  }
  // Member: steer_max_speed
  {
    cdr << ros_message.steer_max_speed;
  }
  // Member: channel
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  loki_msgs::msg::BaseState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: prop_speed
  {
    ...
    size_t item_size = sizeof(ros_message.prop_speed[0]);
  ...
  // Member: prop_pos
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.prop_pos[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: steer_speed
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.steer_speed[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: steer_pos
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.steer_pos[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: steer_max_speed
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.steer_max_speed[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: channel
...
{
  auto typed_message =
    static_cast<const loki_msgs::msg::BaseState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<loki_msgs::msg::BaseState *>(
    untyped_ros_message);
...
{
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_BaseState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, msg, BaseState)() {
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_BaseState__handle;
}
