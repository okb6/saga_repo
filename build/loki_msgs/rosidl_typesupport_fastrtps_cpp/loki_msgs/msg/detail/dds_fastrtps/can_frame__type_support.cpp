...
#include "loki_msgs/msg/detail/can_frame__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const loki_msgs::msg::CANFrame & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  loki_msgs::msg::CANFrame & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const loki_msgs::msg::CANFrame *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<loki_msgs::msg::CANFrame *>(
    untyped_ros_message);
...
{
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_CANFrame__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, msg, CANFrame)() {
  return &loki_msgs::msg::typesupport_fastrtps_cpp::_CANFrame__handle;
}
