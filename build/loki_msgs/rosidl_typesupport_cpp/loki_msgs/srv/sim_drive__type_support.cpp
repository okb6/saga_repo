...
static const _SimDrive_Request_type_support_symbol_names_t _SimDrive_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, srv, SimDrive_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, loki_msgs, srv, SimDrive_Request)),
  }
};
...
{
  return &::loki_msgs::srv::rosidl_typesupport_cpp::SimDrive_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, loki_msgs, srv, SimDrive_Request)() {
  return get_message_type_support_handle<loki_msgs::srv::SimDrive_Request>();
}
...
static const _SimDrive_Response_type_support_symbol_names_t _SimDrive_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, srv, SimDrive_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, loki_msgs, srv, SimDrive_Response)),
  }
};
...
{
  return &::loki_msgs::srv::rosidl_typesupport_cpp::SimDrive_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, loki_msgs, srv, SimDrive_Response)() {
  return get_message_type_support_handle<loki_msgs::srv::SimDrive_Response>();
}
...
static const _SimDrive_type_support_symbol_names_t _SimDrive_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, srv, SimDrive)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, loki_msgs, srv, SimDrive)),
  }
};
...
{
  return &::loki_msgs::srv::rosidl_typesupport_cpp::SimDrive_service_type_support_handle;
}
