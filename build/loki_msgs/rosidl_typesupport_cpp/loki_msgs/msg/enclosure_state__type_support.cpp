...
static const _EnclosureState_type_support_symbol_names_t _EnclosureState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, loki_msgs, msg, EnclosureState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, loki_msgs, msg, EnclosureState)),
  }
};
...
{
  return &::loki_msgs::msg::rosidl_typesupport_cpp::EnclosureState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, loki_msgs, msg, EnclosureState)() {
  return get_message_type_support_handle<loki_msgs::msg::EnclosureState>();
}
